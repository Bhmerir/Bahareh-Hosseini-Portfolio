...
function Resume() {
    return (
        <div class="page resume-page">
            <h5 class="pt-3 ps-5 resume">Download my <a href='https://drive.google.com/file/d/14YyPp3O4kiJ07KBx4AhHj78Cw9f-rH-F/view?usp=sharing' download>Resume</a></h5>
            <h5 class="ps-5 email">My Email Address: <span>mer_ir@yahoo.com</span></h5>
            <br/>
            <h3 class="ps-5">Employment Eligibility</h3>
            <p class="ps-5 resume">
                Permanent Resident of the United States
            </p>
            <br/>
            <h3 class="ps-5">Work Experience</h3>
            <h4 class="ps-5">Retail Sales Associate, TJ Maxx., Santa Clara, California (April 2022-March 2023)</h4>
            <ul class="ps-5">
                <li class="ms-5 resume">
            ...
            <h4 class="ps-5">General Practitioner, Iran, (October 2012-July 2020)</h4>
            <ul class="ps-5">
                <li class="ms-5 resume">
            ...
            <h4 class="ps-5">Software Engineer, Tehran, Iran (Intermittently from 2004 to 2010 for 4 years)</h4>
            <ul class="ps-5">
                <li class="ms-5 resume">
            ...
            <br/>
            <h3 class="ps-5">Education</h3>
            <h4 class="ps-5">Certificate, Full Stack Web Development</h4>
            <p class="ms-5 resume">
                UC Berkeley Extension, June 2023.  
                <br/>
                GPA: 3.94 / 4
                </p>
            <h4 class="ps-5">Doctor of Philosophy, Medicine</h4>
            <p class="ms-5 resume">
                Tehran University of Medical Sciences, Tehran, Iran, August 2012.  
            </p>
            <h5 class="ps-5 italic-text">Dissertation</h5>
            <p class="ms-5 resume"> 
            ...
            <h4 class="ps-5">Bachelor of Science, Computer Software Engineering</h4>
            <p class="ms-5 resume">
                Islamic Azad University, Tehran, Iran, August 2000.
            </p>
            <h5 class="ps-5 italic-text">B.Sc. Thesis</h5>
            <p class="ms-5 resume"> 
            ...
            <br/>
            <h3 class="ps-5">Technical Skills</h3>
            <h4 class="ps-5 italic-text">Computer Literacy</h4>
            <p class="ms-5 resume">
            ...
            <br/>
            <h4 class="ps-5 italic-text">Medical Skills</h4>
            <p class="ms-5 resume">
